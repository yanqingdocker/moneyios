...
@implementation CGInBoxTableViewCell
+ (instancetype)cellForTableView:(UITableView *)tableView
{
    static NSString * ID = @"CGInBoxTableViewCell";
    CGInBoxTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[CGInBoxTableViewCell alloc] initWithStyle:(UITableViewCellStyleDefault) reuseIdentifier:ID];
    }
    return cell;
}
...
- (void)setUI
{
    ...
    _dateLab =     ({
        ...
        label.frame = CGRectMake(SCREEN_WIDTH - 47 - 120,
                                 22,
                                 120,
                                 8);
